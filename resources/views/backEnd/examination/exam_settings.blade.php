                    ...
                    @endif
                            <div class="white-box">
                                <div class="add-visitor">
                                    <div class="row mb-25">
                                        <div class="col-lg-12 mb-30">@php
                                                $format_for = old('format_for') ?? (!isset($editData) || @$editData->exam_type ? 'term_exam' : 'progress_card') ;
                                            @endphp
                                            <select class="niceSelect w-100 bb form-control{{ $errors->has('format_for') ? ' is-invalid' : '' }}" name="format_for" id="format_for">
                                        ...
                                        <div class="col-lg-12 mb-30 term_exam">
                                    ...
                                    <div class="row no-gutters input-right-icon mb-30 term_exam">
