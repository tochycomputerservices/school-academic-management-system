                                        ...
                                        <div class="card-body">
                                            <div class="student_marks_table">
                                                <div class="row">
                                                    ...
                                                    <table style="max-width: 400px;" class="table border_table gray_header_table mb_30 max-width-400 ml-auto mr-auto report_table  @if(resultPrintStatus('vertical_boarder')) mt-5 @endif">
                                                        <tbody>
                                                        {{-- Total Marks Start --}}
                                                        <tr>
