       ...
       <div class="invoice_wrapper">
           ...
           <div class="{{(resultPrintStatus('body'))? "meritTableBody": "meritTableBodyCustomReport"}}">
               ...
               <div class="student_name_highlight" style="text-align: center; margin-bottom: 20px;">
                   <h4> <span style="border-bottom: 3px double; font-size: 20px; ">@lang('reports.progress_report')</span></h4>
               </div>

                   <table class="table border_table align-center gray_header_table mb-0" >
                       <thead>
                       <tr>
                           <th rowspan="2" style="border-bottom: 1px solid #000 !important; ">@lang('common.subjects')</th>
                           ...
                           @endforeach
                           @if(resultPrintStatus('vertical_boarder'))
                               <th rowspan="2">@lang('exam.total')</th>
                               <th rowspan="2">@lang('exam.average')</th>
                               <th rowspan="2">@lang('exam.letter_grade')</th>
                           @endif
                       </tr>
                       <tr>
                           @foreach($assinged_exam_types as $assinged_exam_type)
                   ...
                   <table class="table border_table gray_header_table max-width-400 ml_auto margin-auto report_table" @if(resultPrintStatus('vertical_boarder')) style="margin-top: 20px" @endif>
                       <tbody>
                       <tr>
                       ...
                       <table style="width:100%; margin-top: auto;" class="border-0">
                           ...
                           <tr>
                               <td class="border-0" style="border: 0 !important;">
                                   <p class="result-date" style="text-align:left; float:left; margin-top:50px;  display:inline-block; padding-left: 0; color: #000;">
