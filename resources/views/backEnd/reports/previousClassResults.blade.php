...
<section class="sms-breadcrumb mb-40 white-box">
    ...
    <section class="admin-visitor-area mb-40">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="white-box">
                    {{ Form::open(['class' => 'form-horizontal', 'route' => 'previous-student-record', 'method' => 'POST', 'id' => 'admissionNoSearch']) }}
                        <div class="row align-items-center">
                                ...
                                <div class="col-lg-4 col-xl-5 mt-30-md md_mb_20" id="selectRecordDiv">
                                    <select class="w-100 bb niceSelect form-control{{ $errors->has('record') ? ' is-invalid' : '' }} select_record" id="record" name="record">
